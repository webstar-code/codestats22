...
const Sidebar = () => {
  return (
    <div className=" w-64 h-full border-r bg-white py-4 px-10">
      ...
      <div className="flex flex-col items-center justify-center">
        <Link href={"/day"}><p className="w-full py-5 hover:bg-indigo-400 text-center cursor-pointer">Today</p></Link>
        <Link href={"/week"}><p className="w-full py-5 hover:bg-indigo-400 text-center cursor-pointer">This week</p></Link>
